...
function indexAnimation() {
    var t = $(".index-bl-green-outline")[0];
    if (!t) return;
    var e = 800;
    animate({
        el: t,
...
function loadVinylPlayer() {
    var songs = [
        {
            author: "Bogdan Dragoslav",
            title: "Vreau sa imbatranesc cu tine",
            src: "/public/songs/vreau-sa-imbatranesc-cu-tine.mp3",
        },
        {
...
var translations = {
    "ro": {
        ...
        "header.date": "1 Noiembrie 2026",
        "story.title": "Povestea noastră",
        "story.subtitle": "25 de ani!?!?!",
        "story.text": "Printre planuri împlinite și provocări depășite în doi am ajuns la „Nunta de Argint”.<br><br>Pentru că ați făcut parte din „poveste”, vrem să sărbătorim împreună.<br><br>Pregătiți-vă pentru o zi plină de povești, muzică bună, dans și nostalgie pe 1 Noiembrie 2026, ora 14:00, la Restaurantul de la Turn.",
        ...
        "facts.fact5_a": "Tia: <a target=\"_blank\" href=\"https://maps.app.goo.gl/tR8tCVfip4kz9QdZ7\"><span class=\"strikethrough\">Malta</span> Parc des Buttes-Chaumont</a><br>Adi: <a target=\"_blank\" href=\"https://maps.app.goo.gl/rAR2dq7VNYqWhKvg9\">Canal Saint-Martin</a>",
        ...
        "stay.hotel_book": " <a target=\"_blank\" style=\"color: #FF5734\" href=\"https://hotel-lecharmant-saint-ouen.fr/fr/restaurant-de-saison-a-saint-ouen\">Apasă aici</a> pentru a rezerva, asigură-te că menționezi că este pentru nunta 'Tia & Adi'.",
        "stay.other_options": "Există multe alte opțiuni disponibile prin booking.com sau Airbnb. Dacă ai nevoie de ajutor sau recomandări, <b>nu ezita să îi contactezi</b> pe Tia sau pe Adi.",
        ...
        "registry.text2": "Dacă poți ajunge, te rugăm să ne anunți <a style=\"color: #FF5734\" href=\"https://forms.gle/MiMwKVWjPGWrqPum9\">apăsând aici</a>.",
        ...
        "footer.text": "Creat cu ❤️ de Tia & Adi după o sticlă de vin."
    }
};
