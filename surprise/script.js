...
var translations = {
    ...
    "fr": {
        ...
        "story.text": "Après 16 ans ensemble (presque la moitié de nos vies) et 10 ans de PACS, nous avons partagé plus de rires, d'aventures et de moments magnifiques que nous ne pourrions en compter. Et comme 2026 est aussi l'année où nous sommes tous les deux devenus Français 🇫🇷, celanous a semblé être le prétexte parfait pour faire la fête à Paris. Ce ne sera pas un mariage traditionnel, mais plutôt une célébration qui ressemble un peu plus à une fête d'anniversaire. Pas de stress. Pas de pression. Pas de dress code. Venez simplement comme vous êtes.",
        ...
        "marriage.text": "Rejoignez-nous à Paris en septembre pour notre 'oui' officiel. Nous célébrerons notre union civile à la mairie du 19e arrondissement, avant de poursuivre autour d'un dîner, de quelques verres et d'une petite fête. Nous avons tellement hâte de partager ce momentavec vous ! ❤️",
        ...
        "events.friday.time2": "17:00 - 1:00",
        "events.friday.where2": "Hôtel Restaurant Le Charmant<br>53 Rue du Landy<br>93400 Saint-Ouen-sur-Seine",
        "events.friday.details2": "Commencez le week-end en douceur avec un verre rafraîchissant dans le cadre magnifique du Charmant. L'occasion de retrouver de vieux amis, d'en rencontrer de nouveaux, et de trinquer au début d'un très joyeux week-end. On a hâte de voir si ce sont les Français ou les Roumains qui mettront le feu sur la piste de danse !",
        "events.saturday.date": "26 Sept",
    ...
    "ro": {
        ...
        "events.friday.time2": "17:00 - 1:00",
        "events.friday.where2": "Hôtel Restaurant Le Charmant<br>53 Rue du Landy<br>93400 Saint-Ouen-sur-Seine",
        "events.friday.details2": "Începem week-end-ul relaxat în superbă locație Le Charmant. Vom povesti cu vechi prieteni, poate vă veți face și unii noi și vom ciocni cu totii un pahar. Suntem curioși să vedem cine va face spectacol pe ringul de dans: francezii sau românii!",
        "events.saturday.date": "26 Sept",
        "events.saturday.name": "Sâmbătă",
        "events.saturday.title": "Brunch de Recuperare",
        "events.saturday.time": "11:00-13:00",
        "events.saturday.where": "La Cantine Bretonne<br>22bis Rue de l'Ourcq<br>75019 Paris",
        "events.saturday.details": "Pentru cei care mai sunt prin preajmă sâmbătă, vă invităm la un prânz relaxant. Vă așteptăm cu clătite (crêpes) fără gem (cel puțin la prima servire) la La Cantine Bretonne.",
        "stay.intro_title": "Le Temps de l’Amour",
        "stay.intro_subtitle1": "Paris",
