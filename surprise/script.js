...
function loadEnvelope() {
    var e = document.querySelector(".js-envelope-seal"),
        t = document.querySelector(".js-envelope");
    e &&
        e.addEventListener("click", function () {
            t.classList.toggle("is-open");
        });
}
function loadVinylPlayer() {
    var songs = [
        {
            author: "Eric Prydz",
            title: "Call On Me",
            src: "/public/songs/eric-prydz-call-on-me.mp3",
        },
        {
            author: "Simina Stanciu",
            title: "Greu iti e cu dragostea",
            src: "/public/songs/simina-stanciu-greu-iti-e-cu-dragostea.mp3",
        },
        {
            author: "ROA",
            title: "Neplace",
            src: "/public/songs/roa-neplace.mp3",
        },
        {
            author: "Zinaida Julea",
            title: "Sarba de demult",
            src: "/public/songs/zinaida-julea-sarba-de-demult.mp3",
        },
        {
            author: "Gilbert Montagné",
            title: "Les Sunlights des tropiques",
            src: "/public/songs/gilbert-montagne-les-sunlights-des-tropiques.mp3",
        },
        {
            author: "Claude François",
            title: "Alexandrie Alexandra",
            src: "/public/songs/claude-francois-alexandrie-alexandra.mp3",
        },
    ];
        ...
        if (isPlaying) {
            ...
            if (playPromise !== undefined) {
                playPromise.then(function () {
                    ...
                    $vinil.addClass("is-spinning");
                }).catch(function (error) {
                    // Autoplay blocked
                    isPlaying = false;
                    $icon.attr("name", "play");
                    $vinil.removeClass("is-spinning");
                });
            }
        } else {
            audio.pause();
    ...
    $vinil.on("mouseenter", function () {
        $player.addClass("is-visible");
        $(".index-header__vinil-text").css("opacity", "0");
    ...
    // Handle explicit click on vinyl to start/stop (satisfies user interaction)
    $vinil.on("click", function () {
        isPlaying = !isPlaying;
        updateSong();
    });

    $(".js-player-toggle").on("click", function (e) {
        e.stopPropagation(); // Prevent vinyl click from triggering
        isPlaying = !isPlaying;
        updateSong();
    });

    $(".js-player-next").on("click", function (e) {
        e.stopPropagation();
    ...
    $(".js-player-prev").on("click", function (e) {
        e.stopPropagation();
...
var translations = {
    "en": {
        ...
        "facts.subtitle": "A quirky quiz about the happy couple",
        "facts.click": "Click",
        "facts.hover": "Hover",
    ...
    "fr": {
        ...
        "nav.rsvp": "RSVP",
        "header.vinyl_warning": "Ne cliquez pas<br>sur le vinyle !",
        "header.date": "25 septembre 2026",
        "story.title": "Notre Histoire",
        "story.subtitle": "Se Dire 'oui' à Paris.",
        "story.text": "Après 16 ans ensemble (presque la moitié de nos vies) et 10 ans de PACS, nous avons partagé plus de rires, d'aventures et de moments magnifiques que nous ne pourrions en compter. Et comme 2026 est aussi l'année où nous sommes tous les deux devenus Français 🇫🇷, cela nous a semblé être le prétexte parfait pour faire la fête à Paris. Ce ne sera pas un mariage traditionnel, mais plutôt une célébration qui ressemble un peu plus à une fête d'anniversaire. Pas de stress. Pas de pression. Pas de dress code. Venez simplement comme vous êtes.",
        "facts.title": "Anecdotes",
        "facts.subtitle": "Un petit quiz sur les futurs mariés",
        "facts.click": "Cliquez",
        "facts.hover": "Survolez",
        "facts.for_answer": "pour voir la réponse",
        "facts.fact1_q": "Depuis combien de temps sommes-nous ensemble ?",
        ...
        "marriage.subtitle": "Les festivités",
        "marriage.text": "Rejoignez-nous à Paris en septembre pour notre 'oui' officiel. Nous célébrerons notre union civile à la mairie du 19e arrondissement, avant de poursuivre autour d'un dîner, de quelques verres et d'une petite fête. Nous avons tellement hâte de partager ce moment avec vous ! ❤️",
        "events.title": "Du fun sous le soleil (on l'espère)",
        "events.subtitle1": "Le programme",
        "events.subtitle2": "du week-end",
        "events.day": "Jour",
        ...
        "events.friday.time2": "17:00 - 1:00",
        "events.friday.where2": "Hôtel Restaurant Le Charmant<br>53 Rue du Landy<br>93400 Saint-Ouen-sur-Seine",
        "events.friday.details2": "Commencez le week-end en douceur avec un verre dans le cadre magnifique du Charmant. L'occasion de retrouver de vieux amis, d'en rencontrer de nouveaux, et de trinquer au début d'un très joyeux week-end. On a hâte de voir si ce sont les Français ou les Roumains qui mettront le feu sur la piste de danse !",
        "events.saturday.date": "26 Sept",
        ...
        "registry.text1": "Avoir une famille et des amis aussi formidables dans notre vie est le plus beau des cadeaux.",
        "registry.text2": "Si vous pouvez venir, merci de nous le confirmer en <a style=\"color: #FF5734\" href=\"https://docs.google.com/forms/d/e/1FAIpQLSeR0944tC5XnLzcp_ttfgOx_PPWGuOVlYyxBHPPrNim2hr4Bw/viewform?usp=publish-editor\">cliquant ici</a>.",
        "witnesses.title": "Témoins",
        "witnesses.text": "Un merci tout particulier à nos témoins, Clara & Marina, que nous aimons de tout cœur, et que vous allez forcément adorer.",
    ...
    "ro": {
        ...
        "facts.fact5_a": "Alina: <a target=\"_blank\" href=\"https://maps.app.goo.gl/tR8tCVfip4kz9QdZ7\"><span class=\"strikethrough\">Malta</span> Parc des Buttes-Chaumont</a><br>Bogdan: <a target=\"_blank\" href=\"https://maps.app.goo.gl/rAR2dq7VNYqWhKvg9\">Canal Saint-Martin</a>",
        "marriage.title": "Vă așteptăm la Paris",
        "marriage.subtitle": "Sărbătorim împreună",
        "marriage.text": "Vă așteptăm la Paris în luna septembrie, când vom spune oficial 'oui'. Vom celebra ceremonia civilă la Primăria Arondismentului 19, urmată de o mică petrecere. Abia așteptăm să sărbătorim alături de voi! ❤️",
        "events.title": "Distracție la soare (să sperăm)",
        "events.subtitle1": "Evenimentele",
        "events.subtitle2": "din Weekend",
        "events.day": "Ziua",
        ...
        "events.friday.time2": "17:00 - 1:00",
        "events.friday.where2": "Hôtel Restaurant Le Charmant<br>53 Rue du Landy<br>93400 Saint-Ouen-sur-Seine",
        "events.friday.details2": "Începem week-end-ul relaxant în superba locație Le Charmant. Vom sta la povești cu prietenii noștri (poate vă veți face și voi prieteni noi) și vom ciocni cu toții un pahar. Suntem curioși să vedem cine va face spectacol pe ringul de dans: francezii sau românii! 🇷🇴 🇫🇷",
        "events.saturday.date": "26 Sept",
        "events.saturday.name": "Sâmbătă",
        "events.saturday.title": "Brunch de Recuperare",
        "events.saturday.time": "11:00-13:00",
        "events.saturday.where": "La Cantine Bretonne<br>22bis Rue de l'Ourcq<br>75019 Paris",
        "events.saturday.details": "Pentru cei care mai sunt prin preajmă sâmbătă, vă invităm la un prânz relaxant. Vă așteptăm la clătite (crêpes) fără gem (cel puțin la prima servire) La Cantine Bretonne.",
        "stay.intro_title": "Le Temps de l’Amour",
        "stay.intro_subtitle1": "Paris",
...
if (document.body.classList.contains("save-the-date")) {
    setTimeout(function () {
        startAnimation();
    }, 1200);
}
